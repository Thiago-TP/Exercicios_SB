...
04. JMPP    N1_MAIOR_QUE_N2         CASO_N3_N1:             60  07  N1_MAIOR_QUE_N2
    ;N2_MAIOR_QUE_N1:               
06. LOAD    N2                      Tabela de Usos                      10  N2
08. SUB     N3                      N1: 1+ 15+ 19+ 27+ 37+ 55+ 61+      02  N3
10. JMPP    N2_MAIOR_QUE_N1_E_N3    N2: 3+  7+ 25+ 31+ 45+ 49+ 57+      07  N2_MAIOR_QUE_N1_E_N3
    ;CASO_N1_N3:                    N3: 9+ 13+ 21+ 33+ 39+ 43+ 51+ 63+
12. OUTPUT  N1                      RETURN: 17+ 29+ 35+ 47+ 59+ 65+     13  N3
14. OUTPUT  N3                                                          13  N1
16. JMP     RETURN                  Tabela de Definições                05  RETURN
18. N2_MAIOR_QUE_N1_E_N3:           MOD2:                   00                  
    LOAD    N1                      N2_MAIOR_QUE_N1_E_N3:   18          10  N1
20. SUB     N3                      CASO_N3_N2:             30          02  N3
22. JMPP    CASO_N3_N2              N1_MAIOR_QUE_N2:        36          07  CASO_N3_N2
    ;CASO_N1_N2:                    N1_MAIOR_QUE_N2_E_N3:   48
24. OUTPUT  N1                      CASO_N3_N1:             60          13  N1
26. OUTPUT  N2                                                          13  N2
28. JMP     RETURN                                                      05  RETURN
30. CASO_N3_N2:
    OUTPUT  N3                                                          13  N3
32. OUTPUT  N2                                                          13  N2
34. JMP     RETURN                                                      05  RETURN
36. N1_MAIOR_QUE_N2:
    LOAD    N1                                                          10  N1				
38. SUB     N3                                                          02  N3					
40. JMPP    N1_MAIOR_QUE_N2_E_N3                                        07  N1_MAIOR_QUE_N2_E_N3
    ;CASO_N2_N3:
42. OUTPUT  N2                                                          13  N2
44. OUTPUT  N3                                                          13  N3
46. JMP     RETURN                                                      05  RETURN
48. N1_MAIOR_QUE_N2_E_N3:
    LOAD    N2                                                          10  N2	
50. SUB     N3                                                          02  N3		
52. JMPP    CASO_N3_N1                                                  07  CASO_N3_N1      
    ;CASO_N2_N1:
54. OUTPUT  N2                                                          13  N2
56. OUTPUT  N1                                                          13  N1
58. JMP     RETURN                                                      05  RETURN      
60. CASO_N3_N1:
    OUTPUT  N3                                                          13  N3
62. OUTPUT  N1                                                          13  N1
